    ...
    return (
        <LoginContainer>
            ...
            <Card sx={{ width: '50rem', padding: 10, display: 'flex', flexDirection: 'column', gap: 2 }}>
                <Typography variant="h4" marginBottom={2}>LOG IN</Typography>
                <Box >
                ...
                <hr />
                <Typography variant="body" sx={{ fontSize: 20 }} marginBottom={2}>Don't
                    have an account?</Typography>
                <Link to={'/signup'}><Button variant="contained" sx={{
